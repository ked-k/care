...
@section('content')
    <div x-data="{ open: '' }">
        <x-page-header title="Customers" subtitle="Add, remove or update customer list" icon="ik ik-user-plus"
                       :breadcrumbs="['Home' => url('dashboard'), 'Customers' => null]" />

        <x-table title="Customers" :total="100" :from="1" :to="3" :static-pages="5" search>
            <x-slot:actions>
                <button @click="open = 'CustomerAdd'" class="inline-flex items-center gap-1.5 rounded-lg bg-primary-500 px-3 py-2 text-sm font-medium text-white hover:bg-primary-600"><i class="ik ik-plus"></i> Add Customer</button>
            </x-slot:actions>
                <table id="advanced_table" class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-5 py-3">Tovino Thomas</td>
                            <td class="px-5 py-3">219-122-1234</td>
                            <td class="px-5 py-3">tovino@mail.com</td>
                            <td class="px-5 py-3">USA</td>
                            <td class="px-5 py-3">NewYork</td>
                            <td class="px-5 py-3" data-no-export>
                                <div class="flex items-center gap-3">
                                    <a href="#" @click.prevent="open = 'CustomerEdit'" class="text-green-500 hover:text-green-600"><i class="ik ik-edit"></i></a>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-5 py-3">Christopher Alex</td>
                            <td class="px-5 py-3">419-122-1734</td>
                            <td class="px-5 py-3">christpher@mail.com</td>
                            <td class="px-5 py-3">USA</td>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-5 py-3">John DOe</td>
                            <td class="px-5 py-3">129-122-1734</td>
                            <td class="px-5 py-3">doe@mail.com</td>
                            <td class="px-5 py-3">USA</td>
        ...
        {{-- Add Customer modal --}}
        <div x-show="open === 'CustomerAdd'" x-transition.opacity class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" style="display:none">
            <div @click.outside="open = ''" class="w-full max-w-lg rounded-xl bg-white shadow-xl">
                <div class="flex items-center justify-between border-b border-gray-100 px-5 py-4">
                    <h5 class="font-semibold text-gray-700">Add Customer</h5>
        ...
        {{-- Edit Customer modal --}}
        <div x-show="open === 'CustomerEdit'" x-transition.opacity class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" style="display:none">
            <div @click.outside="open = ''" class="w-full max-w-lg rounded-xl bg-white shadow-xl">
                <div class="flex items-center justify-between border-b border-gray-100 px-5 py-4">
                    <h5 class="font-semibold text-gray-700">Edit Customer</h5>
                    <button type="button" @click="open = ''" class="text-gray-400 hover:text-gray-600"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="px-5 py-4">
                    <form class="space-y-4">
                        <div>
                            <label class="mb-1 block text-sm font-medium text-gray-700">Customer Name</label>
                            <input type="text" name="name" placeholder="Enter Customer Name" value="Christopher Alex"
                                   class="w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm outline-none focus:border-primary-400 focus:ring-2 focus:ring-primary-100">
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-gray-700">Phone</label>
                        ...
                        <div>
                            <label class="mb-1 block text-sm font-medium text-gray-700">Email</label>
                            <input type="text" name="email" placeholder="Enter Email" value="christpher@mail.com"
                                   class="w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm outline-none focus:border-primary-400 focus:ring-2 focus:ring-primary-100">
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-gray-700">Country</label>
