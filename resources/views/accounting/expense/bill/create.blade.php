...
@section('content')
    <x-page-header title="Income" subtitle="Bill" icon="ik ik-user-plus"
                   :breadcrumbs="['Home' => url('accounting'), 'Income' => null, 'Bill' => url('expense/bill')]" />
        ...
        <div class="space-y-5">
            <x-card>
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <x-form.input name="bill_no" label="Bill No" value="#BLO000045" readonly />
        ...
        <div class="xl:sticky xl:top-20 xl:self-start space-y-5">
            <x-card>
                ...
                <div class="mt-4 grid gap-2">
                    <x-button type="submit"><i class="ik ik-check"></i> Save Bill</x-button>
