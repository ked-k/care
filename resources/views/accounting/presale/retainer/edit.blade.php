...
@section('content')
    <x-page-header title="Presale" subtitle="Edit Retainer" icon="ik ik-user-plus"
                ...
                <div class="overflow-x-auto p-5">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            @php
                                $retainerItems = [
                                    ['Item 0', '10', '1200', '0', '12000.00'],
                                    ['Item 1', '5', '700', '0', '3500.00'],
                                    ['Item 2', '12', '80', '60', '900.00'],
                                ];
                            @endphp
                            @foreach ($retainerItems as [$item, $qty, $price, $discount, $sub])
                                <tr class="base-tr">
